...
The Sebastian Software website workspace contains the web frontend in `app/`,
the Sanity content studio in `studio/`, and SST deployment infrastructure.
Use it to develop the website and edit its content together.
...
- Access to the Sanity project and dataset used by the website
